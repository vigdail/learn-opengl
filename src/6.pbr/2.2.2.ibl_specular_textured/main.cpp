...
int main()
{
    ...
    Shader e2cShader("cubemap.vs", "equirectangular_to_cubemap.fs");
    ...
    unsigned int hdrTexture = loadHDRTexture("../../../resources/textures/hdr/newport_loft.hdr");

    stbi_set_flip_vertically_on_load(false);
    // rusted iron
    unsigned int ironAlbedoMap = loadSTexture("../../../resources/textures/pbr/rusted_iron/albedo.png");
    ...
    // gold
    unsigned int goldAlbedoMap = loadSTexture("../../../resources/textures/pbr/gold/albedo.png");
    ...
    // grass
    unsigned int grassAlbedoMap = loadSTexture("../../../resources/textures/pbr/grass/albedo.png");
    ...
    // plastic
    unsigned int plasticAlbedoMap = loadSTexture("../../../resources/textures/pbr/plastic/albedo.png");
    ...
    // wall
    unsigned int wallAlbedoMap = loadSTexture("../../../resources/textures/pbr/wall/albedo.png");
    ...
    e2cShader.setInt("eqiurectangularMap", 0);
    e2cShader.setMatrix4("projection", captureProjection);
    ...
    for (unsigned int i = 0; i < 6; i++)
    {
        e2cShader.setMatrix4("view", captureViews[i]);
    ...
    {
        unsigned int mapWidth = 128 * std::pow(0.5, mip);
        unsigned int mapHeight = 128 * std::pow(0.5, mip);
        glBindRenderbuffer(GL_RENDERBUFFER, captureRBO);
