...
int main()
{
    ...
    for (unsigned int i = 0; i < lightsCount; i++)
    {
        ...
        float y = ((rand() % 100) / 100.0) * 8.0 - 4.0;
        float z = ((rand() % 100) / 100.0) * 8.0 - 4.0;
    ...
    for (unsigned int i = 0; i < lightsCount; i++)
    {
        lightShader.setVec3("lights[" + std::to_string(i) + "].position", lights[i].position);
        lightShader.setVec3("lights[" + std::to_string(i) + "].color", lights[i].color);
        lightShader.setFloat("lights[" + std::to_string(i) + "].linear", 0.7);
        lightShader.setFloat("lights[" + std::to_string(i) + "].quadratic", 1.8);
    }
