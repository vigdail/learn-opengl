...
int main()
{
    ...
    float v1[] = {
        // pos            //color         // uv
        0.5f, 0.5f, 0.0f, 1.0, 0.0, 0.0, 0.55, 0.55,   // top right
        0.5f, -0.5f, 0.0f, 0.0, 1.0, 0.0, 0.55, 0.45,  // bottom right
        -0.5f, -0.5f, 0.0f, 0.0, 0.0, 1.0, 0.45, 0.45, // bottom left
        -0.5f, 0.5f, 0.0f, 0.0, 0.0, 0.0, 0.45, 0.55   // top left
    };
