...
glm::mat4 lookAt(glm::vec3 origin, glm::vec3 target, glm::vec3 worldUp)
{
    glm::vec3 dir = glm::normalize(origin - target);
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 view;
        view = lookAt(camera.position, camera.front + camera.position, camera.worldUp);
