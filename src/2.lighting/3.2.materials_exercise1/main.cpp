...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightPosition.x = 3.0f * cos((float)glfwGetTime());
        lightPosition.y = 0.0f;
        lightPosition.z = 3.0f * sin((float)glfwGetTime());
        ...
        {
            float x = (i % 3) * 2.0f - 2.0f;
            float y = -(i / 3) * 2.0f + 1.0f;
            model = glm::mat4(1.0f);
            ...
            cubeShader.setFloat("material.shininess", 128.0f * materials[i].shininess);
