...
int main()
{
    ...
    int width,
        height, nChannels;
    unsigned char *image = stbi_load("../../../resources/textures/container2.png", &width, &height, &nChannels, 0);
    ...
    unsigned char *emissionImage = stbi_load("../../../resources/textures/matrix.jpg", &width, &height, &nChannels, 0);
    ...
    unsigned int cubeVAO = createCube(vbo);
    unsigned int lightVAO = createLight(vbo);
